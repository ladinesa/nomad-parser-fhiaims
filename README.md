...
```sh
git clone https://github.com/ladinesa/nomad-parser-fhiaims.git
cd nomad-parser-fhiaims
...
| Name | E-mail     |
|------|------------|
| Alvin Noe Ladines | [ladinesalvinnoe@gmail.com](mailto:ladinesalvinnoe@gmail.com)
